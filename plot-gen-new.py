...
# rdf_dict = {
#     "D5-D5": ["CG1-W", "CO-W", "NC-W", "COO2-W"],
#     "D5-G5": ["CG1-W", "CO-W", "NC-W", "COO2-W", "GNC-W"],
#     "D5-single": ["CG1-W", "CO-W", "NC-W", "COO2-W"],
#     "G5-G5": ["CG1-W", "CO-W", "GNC-W"],
#     "G5-single": ["CG1-W", "CO-W", "GNC-W"],
#     "L5-D5": ["CG1-W", "CO-W", "NC-W", "COO2-W", "C41-W"],
#     "L5-G5": ["CG1-W", "CO-W", "NC-W", "C41-W", "GNC-W"],
#     "L5-L5": ["CG1-W", "CO-W", "NC-W", "C41-W"],
#     "L5-single": ["CG1-W", "CO-W", "NC-W", "C41-W"],
#     "PNI": ["CG1-W"]
#     }
...
dist_files = ["rad-PNI"]
evolve_files = ["rad"]
evolve_files2 = ["pni","lig","both-final","pni-wat-final","lig-wat-final"]
#evolve_files2 = ["pni", "lig", "both-final"]
evolve_files3 = ["dist"]
...
for fname in rdf_dict.keys():
    for n in range(len(dist_files)):
        ...
        for i, temp in enumerate(temps):  
            ...
            file1 = "30-5-Run1/" + fname + "/" + str(temp) + "K/" + dist_files[n] + ".dat"
            file2 = "30-5-Run2/" + fname + "/" + str(temp) + "K/" + dist_files[n] + ".dat"
            file3 = "30-5-Run3/" + fname + "/" + str(temp) + "K/" + dist_files[n] + ".dat"
...
#             file1 = "30-5-Run1/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files[n] + ".dat"
#             file2 = "30-5-Run2/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files[n] + ".dat"
#             file3 = "30-5-Run3/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files[n] + ".dat"
...
#             file1 = "30-5-Run1/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files2[n] + ".dat"
#             file2 = "30-5-Run2/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files2[n] + ".dat"
#             file3 = "30-5-Run3/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files2[n] + ".dat"
...
#                     ax.set_yticks(range(25000, 35000, 4000))
#                 elif evolve_files2[n] == "lig-wat-final":
#                     ax.set_xlim(0, 99)
#                     ax.set_xticks(range(0, 100, 20))
#                     ax.tick_params(axis='both', which='major', labelsize=20)
#                     ax.set_ylim(20000, 40000)
#                     ax.set_yticks(range(20000, 40000, 5000))
...
#             file1 = "30-5-Run1/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files3[n] + ".dat"
#             file2 = "30-5-Run2/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files3[n] + ".dat"
#             file3 = "30-5-Run3/" + fname + "/" + str(temp) + "K/Energy/" + evolve_files3[n] + ".dat"
